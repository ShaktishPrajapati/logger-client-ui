...
export function LineGraphNew() {
    ...
    useEffect(() => {
        ...
        // console.log("line graph table", data)
        // console.log("LineCount date", LineCount.map(item => item.date))
        // console.log("graphData", graphData.map(items => items.countLog))
        // console.log("lineGraphRef", lineGraphRef.current.data.datasets[0].data == [])

        // if (lineGraphRef.current.data.datasets[0].data == []) {
        //     setTimeout(function () {
