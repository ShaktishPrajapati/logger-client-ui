        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Row>
                        <Col>
                            <Button className="btn btn-primary" onClick={resetAllfilters}>Reset Filter</Button>
                            <Button className="btn btn-primary ml-2" onClick={saveSearch}>Save Filter</Button>
                            <Button className="btn btn-primary ml-2" onClick={applyDataFiledForm}>Apply Filter</Button>
                        </Col>
                    </Row>
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col>
                            <ListGroup>
                                <ListGroup.Item style={{ cursor: 'pointer' }} className={activeClass.dateField ? "Active-opt" : "Inactive-opt"} onClick={dateField}>Date</ListGroup.Item>
                                <ListGroup.Item style={{ cursor: 'pointer' }} className={activeClass.selectionField ? "Active-opt" : "Inactive-opt"} onClick={selectionField}> Select an option</ListGroup.Item>
                                <ListGroup.Item style={{ cursor: 'pointer' }} className={activeClass.datePerPage ? "Active-opt" : "Inactive-opt"} onClick={datePerPage}> Data per page</ListGroup.Item>
                            </ListGroup>
                        </Col>
                        ...
                        <Col>
                            {dateFieldDisplay ? (
                                <section>
                                    <label style={{ color: "#3E8BE2" }} className="p-1">Start date</label>
                                    <input style={{ border: "1px solid #3E8BE2", borderRadius: "10px" }} type="date" className="p-1" value={date.start}
                                        onChange={(e) =>
                                            setDate({ ...date, start: e.target.value })
                                        } />
                                    <label style={{ color: "#3E8BE2" }} className="p-1">Last date</label>
                                    <input style={{ border: "1px solid #3E8BE2", borderRadius: "10px" }} type="date" className="p-1" value={date.end}
                                ...
                                <section>
                                    <Row>
                                        <label for="Debug" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="Debug" checked={logType.debug} onClick={(e) => {
                                                setLogType({
                                                    ...logType,
                                                    debug: !logType.debug,
                                                });
                                    ...
                                    <Row>
                                        <label for="warn" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="warn" checked={logType.warn} onClick={(e) => {
                                                setLogType({
                                                    ...logType,
                                                    warn: !logType.warn,
                                                });
                                    ...
                                    <label for="Info" style={{ color: "#3E8BE2" }}>
                                        <input type="checkbox" id="Info" onClick={(e) => {
                                            setLogType({
                                                ...logType,
                                                info: !logType.info,
                                            });
                                    ...
                                    <Row>
                                        <label for="Error" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="Error" onClick={(e) => {
                                                setLogType({
                                                    ...logType,
                                                    error: !logType.error,
                                                });
                                ...
                                <section >
                                    <Row>
                                        <label for="10" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="10" checked={record === 10} onClick={(e) => {
                                                setRecords(10);
                                            }} />
                                            &nbsp;   10
                                        </label>
                                    ...
                                    <Row>
                                        <label for="25" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="25" checked={record === 25} onClick={(e) => {
                                                setRecords(25)
                                            }} />
                                            &nbsp; 25
                                        </label>
                                    ...
                                    <label for="50" style={{ color: "#3E8BE2" }}>
                                        <input type="checkbox" id="50" checked={record === 50} onClick={(e) => {
                                            setRecords(50)
                                        }} />
                                        &nbsp;  50
                                    </label>
                                    <Row>
                                        <label for="100" style={{ color: "#3E8BE2" }}>
                                            <input type="checkbox" id="100" checked={record === 100} onClick={(e) => {
                                                setRecords(100)
                                            }} />
                                            &nbsp;   100
                                        </label>
